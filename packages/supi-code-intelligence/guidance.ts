...
- pattern: Bounded text search with grouped matches, context lines, and scope enforcement
...
export const promptGuidelines = [
  ...
  "Use `code_intel pattern` for bounded, scope-aware text search when the question is textual rather than semantic.",
