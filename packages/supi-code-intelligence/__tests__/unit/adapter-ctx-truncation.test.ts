...
import { registerCodeIntelligenceTools } from "../../src/tool/register-tools.ts";
import type { CodeIntelligenceToolDefinitionSpec } from "../../src/tool/tool-specs.ts";
...
describe("registerCodeIntelligenceTools adapter", () => {
  it("forwards cwd, signal, and onUpdate from the pi execute() call to spec.run", async () => {
    ...
    registerCodeIntelligenceTools(pi as never, undefined, [
