...
export function buildPlannerSystemPrompt(): string {
  return [
    ...
    "Each task must be answerable by static inspection of the selected target.",
    "Reviewers receive only list_review_changes, list_review_files, read_review_diff, read_review_file, search_review_files, and submit_review.",
    "Reviewers cannot run shell commands, launch PI, invoke nested reviews, or inspect live runtime/accounting state.",
    "Do not request runtime experiments, command execution, or verification outside those tools.",
