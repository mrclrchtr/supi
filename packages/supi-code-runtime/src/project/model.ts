// Shared project model — scans project metadata to build a structural
// workspace model that powers both auto-injected overviews and on-demand briefs.

import * as fs from "node:fs";
import * as path from "node:path";
import { findProjectRoot, isWithinOrEqual, walkProject } from "@mrclrchtr/supi-core/project";
