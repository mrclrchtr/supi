...
**Combined Patch**:
The generated patch that pnpm applies to the pinned dependency.

**Skill Mirror**:
The committed root `skills/` output generated from the patched dependency. skills.sh installs skills from this catalog.
