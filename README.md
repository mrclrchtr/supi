...
| [`supi-web`](packages/supi-web/README.md) | Public-page-to-Markdown fetching, public web source search, context-safe large output, and focused Context7 documentation | `pi install npm:@mrclrchtr/supi-web` |
