...
- Root `skills/` is the skills.sh catalog generated by `supi-skill-patches`. Keep it out of the root `pi.skills` manifest. Project-local `.pi/skills/` entries are symlinks to selected catalog skills.
