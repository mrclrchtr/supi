...
- Root `skills/` is the skills.sh catalog generated by `supi-skill-patches`. The generated `.claude-plugin/marketplace.json` groups the public catalog into Matt Pocock and SuPi skills for skills.sh. Keep the catalog out of the root `pi.skills` manifest. Project-local `.pi/skills/` entries are symlinks to selected catalog skills.
