...
Purpose: Skip context injection (root refresh and subdirectory re-injection) when the context window usage exceeds a configurable threshold, preserving first-time subdirectory discovery regardless of context pressure.
