...
## Purpose
Custom `registerMessageRenderer` implementations for `supi-claude-md-refresh` and `lsp-context` message types, providing themed, collapsible TUI rendering of injected context.
