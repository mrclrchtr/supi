...
The Claude-MD settings section SHALL provide a text-input editor for `rereadInterval`.
...
- **THEN** the value `0` is persisted, disabling periodic root refresh and subdirectory re-read behavior
